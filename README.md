...
### **굿바이브** | 2024.05 - 현재 | **웹 개발자**
- **클라우드 서버 관리**: AWS 기반 클라우드 환경에서 서버를 안정적으로 관리하며, Docker를 활용해 일관된 로컬 개발 환경을 구축하여 개발 효율성을 향상시켰습니다.
- **CI/CD 파이프라인 최적화**: TeamCity를 활용해 CI/CD 파이프라인을 설계 및 구현, 배포 시간을 50% 단축하고 배포 실패율을 현저히 감소시켰습니다.
- **전자상거래 웹 애플리케이션 개발**: Laravel 프레임워크를 활용하여 월간 30만 명 이상의 사용자를 지원하는 대규모 전자상거래 플랫폼을 설계, 개발 및 유지보수하였습니다.

### **인라이플** | 2018.06 - 2023.10 | **웹 개발자**
- **리드 개발자 역할 수행**: 14명으로 구성된 팀에서 한 영역의 리드 개발자로서 프로젝트 관리, 기술적 의사결정, 코드 리뷰를 주도하며 팀의 성과를 극대화하였습니다.
- **웹 애플리케이션 설계 및 협업**: 기획팀, DBA팀과 긴밀히 협력하여 사용자 친화적이고 확장성 있는 웹 애플리케이션을 설계 및 구현하였습니다.
- **대규모 데이터 처리 시스템 구축**: MySQL과 Clickhouse를 활용하여 대규모 데이터를 분석하고 통계 데이터를 적재하며, 실시간 데이터 처리 시스템을 설계 및 개발하여 효율성을 향상시켰습니다.

---

## 프로젝트

<!--### **전자상 거래 플랫폼 구축** | 2024.06 - 2024.12
- **개요**:
- **역할**:
- **성과**:
- **주요 기술 스택**:-->
...
- uiux 디자인,웹 앱 퍼블리셔 교육 / 2017.09 - 2018.06
